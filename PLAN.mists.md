...
- [ ] Review shared Lua API changes under `src/lua_api/`: integrated gate passes by moving `auction_verbs`, `bank_storage_verbs`, legacy profession/trainer registrations, and rollout-added temporary Blizzard source patches behind `client-mists`; continue reviewing remaining shared Lua changes.
