...
- [ ] Run the BlizzMove Time manager and Move Pad installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
