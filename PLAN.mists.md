...
- [ ] Add a local Mists panel artifact consistency checker that fails when the latest retained screenshot, frame-dump, and lua-error artifact slug sets diverge.
