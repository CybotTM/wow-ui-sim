...
- [ ] Add a local Mists interaction-coverage checker that compares `docs/baselines/mists-panel-interactions.md` to `docs/baselines/mists-panels.md` and fails when a passing panel row lacks interaction evidence or an explicit documented gap.
