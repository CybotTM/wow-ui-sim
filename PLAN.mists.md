...
- [ ] Add Mists Store/CatalogShop/WowToken/SimpleCheckout parity coverage: create a retained panel row plus interaction tests that load `Blizzard_StoreUI`, show `StoreFrame`/`CatalogShopFrame`, exercise category or product selection and checkout/token affordances, and keep `lua-errors` empty.
