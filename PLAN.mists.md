...
- [ ] Re-run local 38-row Mists panel parity with normal SavedVariables enabled after the Store/CatalogShop row, and fix or promote the first saved-var-only panel regression.
