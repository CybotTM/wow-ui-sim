...
- [ ] Add a local Mists panel evidence checker that fails when `docs/baselines/mists-panels.md` references stale or missing retained artifact paths for the latest local panel parity output tree.
