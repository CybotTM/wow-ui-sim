...
- [ ] Audit bounded installed-addon panel samples against all installed Mists addon manifest rows, record which addons and panel categories have saved-vars panel evidence, and promote the first remaining coverage gap.
