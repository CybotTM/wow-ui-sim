...
- [ ] Run the final local non-CI Mists completion audit from current clean state, covering base `lua-errors`, retained panel artifact guards, installed-addon startup/panel tests, live-GUI smoke validation, and interaction coverage; promote any failure or weak evidence to a concrete top-priority task.
