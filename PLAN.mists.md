...
- [ ] Review scripts, CI, docs, and baseline artifacts outside Mists-specific paths: narrowed addon harness scope to Mists by removing the separate addon-harness workflow, dropping Wrath/Era manifest rows and the Bartender seed shim, and rewriting the addon target docs; continue reviewing remaining scripts/baselines.
