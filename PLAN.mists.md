...
- [ ] Run a bounded local installed-addon panel sample with an item-level Mists addon, covering Character and Inspect/Guild Control panels with normal SavedVariables, and fix or promote the first addon-specific regression.
