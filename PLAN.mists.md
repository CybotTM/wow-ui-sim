...
- [ ] Add a local Mists panel lua-error artifact checker that fails when any latest retained panel parity row is missing `lua-errors.json` or contains a non-empty error array.
