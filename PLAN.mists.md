...
- [ ] Add a Mists Spellbook/professions interaction test that clicks or invokes a visible profession button and asserts the resulting profession action path, visible profession frame, or recorded cast/action state changes instead of only proving the profession tab renders.
