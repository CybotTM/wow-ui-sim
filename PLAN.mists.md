...
- [ ] Add a local Mists panel baseline schema checker that fails if `docs/baselines/mists-panels.md` has malformed rows, unknown statuses, duplicate panel names, or missing screenshot/dump artifact references.
