...
- [ ] Run the BlizzMove Raid unit frames installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
