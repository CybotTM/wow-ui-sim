...
- [ ] Run a bounded local installed-addon panel sample with normal SavedVariables enabled for the Store/CatalogShop row, and fix or promote the first addon-plus-saved-vars regression.
