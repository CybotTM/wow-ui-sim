...
- [ ] Re-run the Mists panel interaction audit and coverage index comparison after the Spellbook/profession action coverage, then promote the first remaining weaker workflow or document that none are currently identified.
