...
- [ ] Review rendering/layout/input changes under `src/iced_app/`, `src/render/`, `src/layout.rs`, `src/texture/`, and `src/widget/`: audit found hit testing, layout cache/cycle guards, button visibility, dump effective visibility, tooltip scaling, masks, and strata/statusbar eligibility are profile-neutral; continue reviewing/gating Mists specialty font registration and legacy paperdoll-slot asset fallback.
