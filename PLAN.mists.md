...
- [x] Fix Mists micro menu Game Menu and Shop buttons so the visible icons dispatch clicks and open the expected panels.
- [x] Fix Mists objective tracker quest/header/button texture loading so tracked objectives show tracker chrome instead of bare text on a black/empty panel.
...
- [x] Reproduce and fix the installed-addon AchievementFrame `expected Lua closure in execute` path from `ToggleAchievementFrame`, then retain focused Mists coverage for the clean route.
...
- [x] Run the AllTheThings Encounter Journal installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the Auctionator Bank/Storage installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the DeModal Social/Friends/Guild installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the Leatrix Plus Macro/Keybindings installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the SimpleItemLevel AddOn List installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the Plater AddOn List installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
...
- [x] Run the next local installed-addon panel parity shard with normal SavedVariables for a UI-mutating addon/panel combination not yet represented in the bounded sample, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Spellbook/professions installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Quest log/objective tracker installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove World Map installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Auction House installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Mail installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Collections installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Pet Journal/Battle Pet installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Bank/storage installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Trade window installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
...
- [x] Run the BlizzMove PvP UI installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove LFG/LFR/Raid Browser installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Raid unit frames installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Arena enemy unit frames installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Battlefield map installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Achievements/Calendar installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Archaeology installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Craft panel installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Class trainer installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Encounter Journal installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Challenge mode installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Currency and Token installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Item services installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove NPC services installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Macro and key bindings installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Interface options installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the BlizzMove Time manager and Move Pad installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
...
- [x] Run the Auctionator Interface Options installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the Leatrix_Maps Interface Options installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the DialogueUI Interface Options installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the SimpleItemLevel Interface Options installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the AllTheThings Interface Options installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the DeModal Interface Options installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the DeModal AddOn List installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the AllTheThings AddOn List installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
- [x] Run the Auctionator AddOn List installed-addon panel parity shard with normal SavedVariables, document retained artifacts, and fix the first panel-specific `lua-errors` or render regression before broadening.
...
- [x] Refresh the retained local Mists parity artifact references if the completion audit writes a newer artifact root, and verify the baseline guards still reject stale screenshot/dump/log references.
...
- [x] Fix Mists installed-addon discovery so normal app startup scans the active `_classic_/Interface/AddOns` install root instead of only the repo's simulator support addons.
- [x] Fix Mists Guild Finder click paths so the Communities list Guild Finder entry and `ToggleGuildFinder()` route open the guild finder panel with seeded rows.
...
- [x] Rebased the Mists rollout branch onto latest `origin/master`.
...
- [x] Review shared Lua API changes under `src/lua_api/`: integrated gate passes by moving `auction_verbs`, `bank_storage_verbs`, legacy profession/trainer registrations, rollout-added temporary Blizzard source patches, the Mists main-menu microbutton mouse-script suppression, newly-added legacy action-bar boolean globals, `C_QuestChoice`, PVP honor/battleground global registrations, legacy spell-tab/skill-line return shapes, and `action_bar_api` special-bar index behavior behind `client-mists`; kept inert `PvpHonorState` storage and the shared MapCanvas scroll/zoom workaround as profile-neutral after retail and Mists app/test checks passed.
- [x] Review shared C API changes under `src/c_api/`: integrated gate passes by moving `legacy_spell_book`, legacy specialization global registrations, legacy `GetSpellInfo`/`GetSpellTexture` globals, and Mists token-auction methods behind `client-mists`; kept PaperDoll, Currency, SpellBook, addon, and container additions as namespaced/profile-neutral model improvements after retail and Mists cargo checks passed.
- [x] Review shared startup sequencing in `src/bin/wow_sim/main.rs`: keep the extra post-Blizzard workaround pass, but gate it behind `client-mists` so retail still only runs the existing final post-load pass.
- [x] Review rendering/layout/input changes under `src/iced_app/`, `src/render/`, `src/layout.rs`, `src/texture/`, and `src/widget/`: audit found hit testing, layout cache/cycle guards, button visibility, dump effective visibility, tooltip scaling, masks, and strata/statusbar eligibility are profile-neutral; gated Mists specialty font registration/tests and the pre-CASC legacy paperdoll-slot asset fallback behind `client-mists`; remaining readability follow-up is splitting oversized `src/render/font.rs` if font work continues.
...
- [x] Review test churn outside `tests/mists_*`: gated classic professions layout, legacy profession spellbook shape, challenge-mode Mists map, legacy ranged/weapon stat, and legacy quest POI table assertions behind `client-mists`; renamed misleading Mists map test to a seeded-world-map test; fixed Mists test compile dependencies on local `Interface/BlizzardUI` files; retail and Mists `cargo check --tests` pass; remaining readability follow-up is splitting oversized `src/iced_app/mouse_tests.rs` if we keep adding hit-test coverage there.
- [x] Review scripts, CI, docs, and baseline artifacts outside Mists-specific paths: narrowed addon harness scope to Mists by removing the separate addon-harness workflow, dropping Wrath/Era manifest rows and the Bartender seed shim, rewriting the addon target docs, pruning non-Mists/startup/perf baseline artifacts, and sweeping stale cross-profile references.
