...
- [ ] Run a bounded local installed-addon panel sample with a map/navigation Mists addon, covering World Map and Quest log with normal SavedVariables, and fix or promote the first addon-specific regression.
