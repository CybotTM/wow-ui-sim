...
- [ ] Run a bounded local installed-addon panel sample with a nameplate/action-bar Mists addon, covering Nameplates and Action bars with normal SavedVariables, and fix or promote the first addon-specific regression.
