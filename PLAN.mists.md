...
- [ ] Run a bounded local installed-addon panel sample with a dialogue replacement Mists addon, covering Quest choice and Quest log with normal SavedVariables, and fix or promote the first addon-specific regression.
