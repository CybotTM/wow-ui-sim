...
- [ ] Audit whether any Mists panel row still lacks retained local asset-backed visual evidence after the 38-row saved-vars and addon samples; promote the first missing artifact or weak visual row to a focused fix.
