...
- [ ] Re-run the local non-release Mists completion audit after adding the Store/CatalogShop panel row, covering base `lua-errors`, full 38-row panel parity, installed-addon startup, live-GUI smoke, interaction audit, and a bounded installed-addon panel sample.
