...
| Interface options | Game-menu options flow, interface category focus, SettingsPanel remains usable with Mists 5.5.4 EditMode present | `tests/mists_interface_options_panel.rs::mists_game_menu_options_drives_settings_help_and_addons` | Mists-specific |
