...
| `BlizzMove` + normal SavedVariables | Raid unit frames LoD panel | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `RaidParentFrame` root dump, seeded Raider rows, and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-raid-unit-frames-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-raid-unit-frames-with-saved-vars-after-scope-guard/BlizzMove/raid-unit-frames/` |
| `BlizzMove` + normal SavedVariables | Arena enemy unit frames LoD panel | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `ArenaEnemyFrame1` and pet-frame rows, and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-arena-unit-frames-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-arena-unit-frames-with-saved-vars-after-scope-guard/BlizzMove/arena-unit-frames/` |
| `BlizzMove` + normal SavedVariables | Battlefield map LoD panel | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `BattlefieldMapFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-battlefield-map-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-battlefield-map-with-saved-vars-after-scope-guard/BlizzMove/battlefield-map/` |
| `BlizzMove` + normal SavedVariables | Achievements and Calendar | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `AchievementFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-achievements-calendar-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-achievements-calendar-with-saved-vars-after-scope-guard/BlizzMove/achievements-calendar/` |
| `BlizzMove` + normal SavedVariables | Archaeology panel | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `ArchaeologyFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-archaeology-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-archaeology-with-saved-vars-after-scope-guard/BlizzMove/archaeology/` |
| `BlizzMove` + normal SavedVariables | Craft panel | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `CraftFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-craft-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-craft-with-saved-vars-after-scope-guard/BlizzMove/craft/` |
| `BlizzMove` + normal SavedVariables | Class trainer LoD panel | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `ClassTrainerFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-class-trainer-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-class-trainer-with-saved-vars-after-scope-guard/BlizzMove/class-trainer/` |
| `BlizzMove` + normal SavedVariables | Encounter Journal | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `EncounterJournal` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-encounter-journal-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-encounter-journal-with-saved-vars-after-scope-guard/BlizzMove/encounter-journal/` |
| `BlizzMove` + normal SavedVariables | Challenge mode LoD panel | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `ChallengesFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-challenges-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-challenges-with-saved-vars-after-scope-guard/BlizzMove/challenges/` |
| `BlizzMove` + normal SavedVariables | Currency and Token UI | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `TokenFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-currency-token-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-currency-token-with-saved-vars-after-scope-guard/BlizzMove/currency-token/` |
| `BlizzMove` + normal SavedVariables | Item socketing, reforging, and upgrade LoD panels | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `ItemUpgradeFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-item-services-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-item-services-with-saved-vars-after-scope-guard/BlizzMove/item-services/` |
| `BlizzMove` + normal SavedVariables | NPC service LoD panels: barber and black market | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `BlackMarketFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-npc-services-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-npc-services-with-saved-vars-after-scope-guard/BlizzMove/npc-services/` |
| `BlizzMove` + normal SavedVariables | Macro and key bindings | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `SettingsPanel` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-macro-keybindings-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-macro-keybindings-with-saved-vars-after-scope-guard/BlizzMove/macro-keybindings/` |
| `BlizzMove` + normal SavedVariables | Interface options | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `SettingsPanel` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-interface-options-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-interface-options-with-saved-vars-after-scope-guard/BlizzMove/interface-options/` |
| `BlizzMove` + normal SavedVariables | Time manager and move pad LoD utilities | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `TimeManagerFrame` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-time-move-utilities-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-time-move-utilities-with-saved-vars-after-scope-guard/BlizzMove/time-move-utilities/` |
| `BlizzMove` + normal SavedVariables | Nameplates | Passed after the scope-limit guard; per-panel `lua-errors` length `0`, visible `MistsNamePlateRenderProbe` root dump and screenshot written | `target/mists-local-addon-panel-sample/blizzmove-nameplates-with-saved-vars-after-scope-guard.log`; artifacts under `target/mists-local-addon-panel-sample/blizzmove-nameplates-with-saved-vars-after-scope-guard/BlizzMove/nameplates/` |
| `BlizzMove` + normal SavedVariables | Loot, group loot, personal loot | Passed after the pet-tab availability refresh; per-panel `lua-errors` length `0`, visible `LootFrame` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/blizzmove-loot-with-saved-vars-after-pet-tab-fix/BlizzMove/loot/` |
...
| `DeModal` + normal SavedVariables | LFG, LFR, Raid Browser | Passed after the Leatrix_Plus PvP shard; per-panel `lua-errors` length `0`, visible `PVEFrame` and `GroupFinderFrame` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/demodal-lfg-lfr-with-saved-vars-after-leatrix-plus-pvp/DeModal/lfg-lfr/` |
...
| `DeModal` + normal SavedVariables | Friends, Who, Guild, Communities, Club Finder | Passed after the Leatrix_Plus Macro/Keybindings shard; per-panel `lua-errors` length `0`, visible `FriendsFrame` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/demodal-social-with-saved-vars-after-leatrix-plus-macro-keybindings/DeModal/social/` |
...
| `Leatrix_Plus` + normal SavedVariables | AddOn list and UI management LoD panels | Passed after the Leatrix_Maps AddOn List shard; per-panel `lua-errors` length `0`, visible `AddonList` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/leatrix-plus-addon-list-with-saved-vars-after-leatrix-maps-addon-list/Leatrix_Plus/addon-list/` |
| `Leatrix_Plus` + normal SavedVariables | Macro and key bindings | Passed after the AddOn List sweep; per-panel `lua-errors` length `0`, visible `SettingsPanel` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/leatrix-plus-macro-keybindings-with-saved-vars-after-addon-list-sweep/Leatrix_Plus/macro-keybindings/` |
| `Leatrix_Plus` + normal SavedVariables | Interface options | Passed after the AllTheThings Achievements/Calendar shard; per-panel `lua-errors` length `0`, visible `SettingsPanel` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/leatrix-plus-interface-options-with-saved-vars-after-allthethings-achievements/Leatrix_Plus/interface-options/` |
| `Leatrix_Plus` + normal SavedVariables | PvP UI: HonorFrame, BG queue, Conquest | Passed after the Leatrix_Maps Battlefield Map shard; per-panel `lua-errors` length `0`, visible `PVPQueueFrame` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/leatrix-plus-pvp-with-saved-vars-after-leatrix-maps-battlefield-map/Leatrix_Plus/pvp/` |
...
| `AllTheThings` + normal SavedVariables | AddOn list and UI management LoD panels | Passed after the DeModal AddOn List shard; per-panel `lua-errors` length `0`, visible `AddonList` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/allthethings-addon-list-with-saved-vars-after-demodal-addon-list/AllTheThings/addon-list/` |
...
| `AllTheThings` + normal SavedVariables | Currency and Token UI | Passed after the DeModal LFG/LFR shard; per-panel `lua-errors` length `0`, visible `TokenFrame` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/allthethings-currency-token-with-saved-vars-after-demodal-lfg-lfr/AllTheThings/currency-token/` |
| `AllTheThings` + normal SavedVariables | Encounter Journal | Passed after the Auctionator Bank/Storage shard; per-panel `lua-errors` length `0`, visible `EncounterJournal` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/allthethings-encounter-journal-with-saved-vars-after-auctionator-bank-storage/AllTheThings/encounter-journal/` |
| `AllTheThings` + normal SavedVariables | Interface options | Passed after the SimpleItemLevel Interface Options shard; per-panel `lua-errors` length `0`, visible `SettingsPanel` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/allthethings-interface-options-with-saved-vars-after-simpleitemlevel-interface-options/AllTheThings/interface-options/` |
...
| `Auctionator` + normal SavedVariables | AddOn list and UI management LoD panels | Passed after the AllTheThings AddOn List shard; per-panel `lua-errors` length `0`, visible `AddonList` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/auctionator-addon-list-with-saved-vars-after-allthethings-addon-list/Auctionator/addon-list/` |
| `Auctionator` + normal SavedVariables | Bank, ReagentBank, Void Storage, Guild Bank | Passed after the DeModal Social shard; per-panel `lua-errors` length `0`, visible `BankFrame` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/auctionator-bank-storage-with-saved-vars-after-demodal-social/Auctionator/bank-storage/` |
...
| `Leatrix_Maps` + normal SavedVariables | AddOn list and UI management LoD panels | Passed after the DialogueUI AddOn List shard; per-panel `lua-errors` length `0`, visible `AddonList` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/leatrix-maps-addon-list-with-saved-vars-after-dialogueui-addon-list/Leatrix_Maps/addon-list/` |
| `Leatrix_Maps` + normal SavedVariables | Battlefield map LoD panel | Passed after the AllTheThings Encounter Journal shard; per-panel `lua-errors` length `0`, visible `BattlefieldMapFrame` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/leatrix-maps-battlefield-map-with-saved-vars-after-allthethings-encounter-journal/Leatrix_Maps/battlefield-map/` |
| `Leatrix_Maps` + normal SavedVariables | Interface options | Passed after the Auctionator Interface Options shard; per-panel `lua-errors` length `0`, visible `SettingsPanel` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/leatrix-maps-interface-options-with-saved-vars-after-auctionator-interface-options/Leatrix_Maps/interface-options/` |
...
| `DialogueUI` + normal SavedVariables | AddOn list and UI management LoD panels | Passed after the Auctionator AddOn List shard; per-panel `lua-errors` length `0`, visible `AddonList` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/dialogueui-addon-list-with-saved-vars-after-auctionator-addon-list/DialogueUI/addon-list/` |
...
| `SimpleItemLevel` + normal SavedVariables | AddOn list and UI management LoD panels | Passed after the Plater AddOn List shard; per-panel `lua-errors` length `0`, visible `AddonList` root dump and screenshot written | Artifacts under `target/mists-local-addon-panel-sample/simpleitemlevel-addon-list-with-saved-vars-after-plater-addon-list/SimpleItemLevel/addon-list/` |
...
release-proof wrapper. Do not run the full installed-addon screenshot matrix as
routine local proof until the runner is optimized for reliable resume markers
...
installed-addon panel screenshot has been exercised locally. Treat the full
matrix as lower-priority, perf-gated evidence unless a specific addon/panel
failure needs a targeted shard.
...
|---|---|
| `AllTheThings` | Collections, AddOn List, Achievements/Calendar, Currency/Token, Encounter Journal, Interface Options, TradeSkill |
| `Auctionator` | Auction House, AddOn List, Bank/Storage, Interface Options, Mail |
| `BlizzMove` | All 38 panel slugs |
| `DeModal` | Store/CatalogShop, AddOn List, Character, Interface Options, LFG/LFR, Spellbook/professions, Social, TradeSkill |
| `DialogueUI` | Quest choice, AddOn List, Interface Options, Quest log |
| `Leatrix_Maps` | World Map, AddOn List, Battlefield Map, Interface Options, Quest log |
| `Leatrix_Plus` | Spellbook/professions, AddOn List, Macro/Keybindings, Interface Options, PvP, TradeSkill |
| `Plater` | Nameplates, AddOn List, Interface Options, Action bars |
| `SimpleItemLevel` | Character, AddOn List, Interface Options, Inspect/Guild Control |
