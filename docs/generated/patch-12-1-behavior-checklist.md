1. [exception-requested] `changed:Patch12_1.UnitAura.AddonSecretError` — unsafe
2. [exception-requested] `changed:Patch12_1.UnitAura.BlizzardSecretAccess` — unsafe
3. [exception-requested] `changed:Patch12_1.UnitAura.SecretAuraData` — unsafe
4. [exception-requested] `changed:Patch12_1.UnitAura.SecretEventPayload` — unsafe
5. [exception-requested] `changed:Patch12_1.PrivateScriptObjects.PrivateIdentity` — unsafe
6. [exception-requested] `changed:Patch12_1.PrivateScriptObjects.InaccessiblePublicKeys` — unsafe
7. [exception-requested] `changed:Patch12_1.PrivateScriptObjects.ChildVisibility` — unsafe
8. [exception-requested] `changed:Patch12_1.PrivateScriptObjects.HookBoundary` — unsafe
9. [exception-requested] `changed:Patch12_1.PrivateScriptObjects.ScriptStorage` — unsafe
10. [exception-requested] `changed:Patch12_1.PrivateScriptObjects.SecureDelegateEnforcement` — unsafe
11. [exception-requested] `changed:Patch12_1.ForbiddenAspects.UntrustedScriptExecution` — unsafe
12. [exception-requested] `changed:Patch12_1.ForbiddenAspects.UntrustedLayoutScriptExecution` — unsafe
13. [exception-requested] `changed:Patch12_1.ForbiddenAspects.EventRegistrations` — unsafe
14. [exception-requested] `changed:Patch12_1.ForbiddenAspects.AlwaysPropagateInput` — unsafe
15. [exception-requested] `changed:Patch12_1.ForbiddenAspects.ScriptedInput` — unsafe
16. [exception-requested] `changed:Patch12_1.ForbiddenAspects.QueryFocus` — unsafe
...
50. [exception-requested] `changed:Patch12_1.Service.PrivateAura.Payloads` — unsafe
51. [exception-requested] `changed:Patch12_1.StrictRemoval.PreStartupVisibility` — unsafe
...
54. [exception-requested] `changed:Patch12_1.StrictRemoval.WrapperTiming` — unsafe
