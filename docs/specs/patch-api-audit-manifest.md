...
- `data/patch-api/12.0.5-probes.json` — 38-row probe manifest: 33 best-effort rows, 5 exception-requested rows (2 approved impossible and 3 unapproved unsafe Store), and zero untriaged rows.
