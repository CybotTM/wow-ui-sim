...
- `data/patch-api/sources/12.0.0-register.json` — 3410-occurrence wowless snapshot register: 2554 added, 313 changed, 543 removed; the current manifest has 36 best-effort, 52 evidence-required, and 3322 untriaged rows, including 17 untriaged curve metadata rows.
