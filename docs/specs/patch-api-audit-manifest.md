...
- `data/patch-api/sources/12.0.0-register.json` — 3410-occurrence wowless snapshot register: 2554 added, 313 changed, 543 removed; the current manifest has 77 best-effort, 116 evidence-required, and 3217 untriaged rows, including 17 untriaged curve metadata rows, the 12-row C_Spell evidence-required slice, and the bounded C_TradeSkillUI slice.
