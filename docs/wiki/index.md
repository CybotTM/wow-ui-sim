...
| [[patch-12-1-api-audit]] | 12.1 audit split: 432-row FrameXML register complete; separate 53-row broader behavior register has 13 direct-test-backed best-effort rows and 40 untriaged |
...
| [[patch-12-1-behavior-inventory]] | 53 non-FrameXML behavior boundaries: 0 implemented, 13 best-effort, 0 exception-requested, 40 untriaged; candidate split is 30 safe best-effort, 20 unsafe, and 3 impossible |
