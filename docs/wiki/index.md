...
| [[patch-12-1-api-audit]] | 12.1 audit split: 432-row FrameXML register complete; separate 54-row broader behavior register has 15 direct-test-backed best-effort rows and 39 untriaged |
...
| [[patch-12-1-behavior-inventory]] | 54 non-FrameXML behavior boundaries: 0 implemented, 15 best-effort, 0 exception-requested, 39 untriaged; candidate split is 30 safe best-effort, 21 unsafe, and 3 impossible |
