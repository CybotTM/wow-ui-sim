...
| [[patch-12-1-framexml-symbol-inventory]] | Exhaustive 320-added/112-removed local FrameXML snapshot: 1 implemented, 16 best-effort, 415 exception-requested; includes explicit PTR LoD proof for reversed-name mismatches (430 distinct names; two duplicates) |
