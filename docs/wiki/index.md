...
| [[patch-12-1-framexml-symbol-inventory]] | Exhaustive 320-added/112-removed local FrameXML snapshot: one tested wrapper implemented, 431 entries explicitly exception-requested pending ownership/lifecycle proof (430 distinct names; two occur in both lists) |
