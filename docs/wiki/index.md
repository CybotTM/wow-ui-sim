...
| Page | Summary |
|------|---------|
| [[patch-12-0-5-api-audit]] | 12.0.5 probe-driven audit: 30 rows have direct behavioral evidence and 8 remain neutral pending exact replay, provenance, or live Store/window evidence |
| [[patch-12-0-5-probe-inventory]] | 38-row 12.0.5 probe register: 30 best-effort, 0 implemented, 0 exception-requested, 8 untriaged; prior documented states remain separate |
