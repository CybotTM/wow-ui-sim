...
| Page | Summary |
|------|---------|
| [[patch-12-0-0-api-audit]] | 12.0.0 wowless snapshot audit: 38 best-effort rows (including the bounded C_Timer NewTimer/NewTicker behavioral slice), 53 evidence-required unsafe rows including 23 unresolved curve contracts, 8 unpublished C_StringUtil functions, and C_Timer.After without executable proof, 3319 untriaged occurrences including 17 curve metadata rows, 2554 added / 313 changed / 543 removed; no historical FrameXML or live-runtime claim |
