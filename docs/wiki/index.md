...
| Page | Summary |
|------|---------|
| [[patch-12-0-5-api-audit]] | 12.0.5 probe-driven audit: 16 rows have direct behavioral evidence and 22 remain neutral pending exact replay, provenance, or live Store/window evidence |
| [[patch-12-0-5-probe-inventory]] | 38-row 12.0.5 probe register: 16 best-effort, 0 implemented, 0 exception-requested, 22 untriaged; prior documented states remain separate |
