...
| [[on-update-dirty]] | Blanket dirty discard suppresses cast bar; now tracks the solo CompactRaidFrameManager cleanup plus the remaining leave-button query path and BuffFrame duration/font churn |
