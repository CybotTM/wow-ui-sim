...
| [[patch-12-1-framexml-symbol-inventory]] | Exhaustive 320-added/112-removed local FrameXML snapshot: 1 implemented, 15 best-effort, 416 exception-requested; includes explicit PTR LoD proof for the ItemUpgrade reversed-name mismatch (430 distinct names; two duplicates) |
