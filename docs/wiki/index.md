...
| [[game-menu-esc-handlers]] | `RegisterGameMenuEscHandler` / `GameMenuEscPriority` were missing, aborting 25 Blizzard files at file scope and leaving every `EditModeSystemTemplate` frame without a completed `OnLoad` |
