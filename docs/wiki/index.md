...
| [[patch-12-1-framexml-symbol-inventory]] | Exhaustive 320-added/112-removed local FrameXML snapshot: 1 implemented, 120 best-effort, 0 exception-requested, 311 untriaged; includes explicit PTR source and LoD runtime proof for mismatches (430 distinct names; two duplicates) |
