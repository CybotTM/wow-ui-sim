...
| [[three-slice-button-tiling]] | Escape menu red button artifacts came from using the full non-seamless Center strip; red-button centers now tile a seam-safe center column |
