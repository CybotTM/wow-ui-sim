...
| Page | Summary |
|------|---------|
| [[patch-12-0-5-api-audit]] | 12.0.5 probe-driven audit: 33 rows have direct behavioral evidence and 5 remain neutral pending exact replay, provenance, or live Store/window evidence |
| [[patch-12-0-5-probe-inventory]] | 38-row 12.0.5 probe register: 33 best-effort, 0 implemented, 0 exception-requested, 5 untriaged; prior documented states remain separate |
...
| [[patch-12-1-api-audit]] | 12.1 audit split: 432-row FrameXML register complete; separate 54-row broader behavior register has 23 direct-test-backed best-effort rows and 31 untriaged |
...
| [[patch-12-1-behavior-inventory]] | 54 non-FrameXML behavior boundaries: 0 implemented, 23 best-effort, 0 exception-requested, 31 untriaged; candidate split is 30 safe best-effort, 21 unsafe, and 3 impossible |
