...
| Page | Summary |
|------|---------|
| [[patch-12-0-0-api-audit]] | 12.0.0 wowless snapshot audit: 16 best-effort rows (4 AbbreviateConfig, 12 heal-prediction), 3394 untriaged occurrences, 2554 added / 313 changed / 543 removed; no historical FrameXML or live-runtime claim |
