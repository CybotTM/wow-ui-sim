...
| Page | Summary |
|------|---------|
| [[patch-12-0-0-api-audit]] | 12.0.0 wowless snapshot audit: 36 best-effort rows (including C_StringUtil.EscapeQuotedCodes limited to tested quoted-code pipe escaping), 52 evidence-required unsafe rows including 23 unresolved curve contracts and 8 unpublished C_StringUtil functions that cannot be approved closed, 3322 untriaged occurrences including 17 curve metadata rows, 2554 added / 313 changed / 543 removed; no historical FrameXML or live-runtime claim |
