...
| [[editbox-render-text-cache]] | Focused EditBox keyboard input updated logical text but left stale `text_stripped`, so SimCommands search typed text shaped as empty after `SetText("")` |
