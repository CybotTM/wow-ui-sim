...
| Page | Summary |
|------|---------|
| [[patch-12-0-0-api-audit]] | 12.0.0 wowless snapshot audit: 21 best-effort rows (4 AbbreviateConfig, 12 heal-prediction, 5 FunctionContainer), 3389 untriaged occurrences, 2554 added / 313 changed / 543 removed; no historical FrameXML or live-runtime claim |
