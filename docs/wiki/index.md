...
| [[patch-12-1-api-audit]] | 12.1 audit split: 432-row FrameXML register complete, while the separate 53-row broader behavior register remains fully neutral pending evidence and item-specific approval |
...
| [[patch-12-1-behavior-inventory]] | 53 non-FrameXML behavior boundaries: 0 implemented, 0 best-effort, 0 exception-requested, 53 untriaged; candidate split is 30 safe best-effort, 20 unsafe, and 3 impossible |
