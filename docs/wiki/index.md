...
| [[patch-12-0-7-occurrence-inventory]] | 131-row 12.0.7 register: six named CVar additions implemented from exact defaults, 125 rows untriaged, and crawler-omitted CVar names explicitly not invented |
