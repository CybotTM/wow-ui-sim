...
Clearing the aborts let execution reach code that had never run, which surfaced eleven further defects. Each is its own commit and each was measured, not inferred.
