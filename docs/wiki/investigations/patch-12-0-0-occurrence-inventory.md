...
- **Rows:** 3410 total — 0 implemented, 298 best-effort, 483 evidence-required, 2 exception-requested, 2627 untriaged
...
| `C_ActionBar.ActionBarChargeInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_ActionBar.ActionBarCooldownInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_AdventureMap.AdventureMapQuestPortraitInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_CatalogShop.BulkPurchaseIndividualProductResult` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_CatalogShop.RefundableDecorInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_DamageMeter.DamageMeterAvailableCombatSession` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_DamageMeter.DamageMeterCombatSession` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_DamageMeter.DamageMeterCombatSessionSource` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_DamageMeter.DamageMeterCombatSource` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_DamageMeter.DamageMeterCombatSpell` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_DamageMeter.DamageMeterCombatSpellUnitDetails` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_EventScheduler.EventDisplayInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_HousingCatalog.HousingPreviewItemData` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_MajorFactions.RenownHighlightInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_NeighborhoodInitiative.InitiativeActivityLogEntry` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_NeighborhoodInitiative.InitiativeActivityLogInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_NeighborhoodInitiative.InitiativeMilestoneInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_NeighborhoodInitiative.InitiativeMilestoneRewardInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_NeighborhoodInitiative.InitiativeTaskInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_NeighborhoodInitiative.InitiativeTasksTracked` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_NeighborhoodInitiative.NeighborhoodInitiativeInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_PvP.BattlegroundInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_UIWidgetManager.PreyHuntProgressWidgetVisualizationInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `C_WeeklyRewards.WeeklyRewardActivityTierProgress` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `CraftingQualityInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `CraftingVariableQuantities` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `CriteriaRequiredValue` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `CriteriaRequirement` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `HouseExteriorSizeOption` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `HouseExteriorSizeOptionsInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `HouseExteriorTypeOption` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `HouseExteriorTypeOptionsInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
...
| `HouseLevelInfo` | best-effort | provenance-only | structure | added | Provenance-only: no runtime behavior claimed. |
