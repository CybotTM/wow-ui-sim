...
- **Rows:** 3410 total — 0 implemented, 124 best-effort, 453 evidence-required, 1 exception-requested, 2832 untriaged
...
| `C_Transmog.TransmogApplyWarningInfo` | untriaged | structure | removed | Metadata-only structure removal remains untriaged; runtime rawget does not prove structure publication absence. |
