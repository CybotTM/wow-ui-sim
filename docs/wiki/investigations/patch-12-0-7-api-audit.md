...
User approved the documented exception set on 2026-07-14. These remain non-implemented fidelity gaps, retained here as itemized approved exceptions rather than completion claims.
