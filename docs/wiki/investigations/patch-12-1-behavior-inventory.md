...
| `Patch12_1.RadialProgress.Constructor` | exception-requested  | impossible  | RadialProgress | changed | A standalone RadialProgress script object can be constructed through an audited retail API. |
| `Patch12_1.RadialProgress.MethodDispatch` | exception-requested  | impossible  | RadialProgress | changed | Standalone RadialProgress methods dispatch through the expected receiver and metatable. |
| `Patch12_1.RadialProgress.StateBehavior` | exception-requested  | impossible  | RadialProgress | changed | A standalone RadialProgress object stores and updates radial progress state. |
