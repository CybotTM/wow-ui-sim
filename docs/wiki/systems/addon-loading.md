...
- [startup warning tests](../../../tests/startup_warnings.rs) and [runtime warning tests](../../../tests/addon_nil_symbol_report.rs) — startup draining and owner-preserving top-level/nested warning proof
