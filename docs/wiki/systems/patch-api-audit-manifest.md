...
Current 12.1 FrameXML totals are **1 implemented, 431 best-effort, 0 exception-requested, and 0 untriaged**. The separate broader behavior register is **0 implemented, 23 best-effort, 0 exception-requested, and 31 untriaged**. The full 12.1 objective remains open.
