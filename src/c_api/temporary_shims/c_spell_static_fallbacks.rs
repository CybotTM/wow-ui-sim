//! C_Spell temporary static fallbacks — spell override, charges, and Maw atlas
//! state are not modeled yet.
//!
//! These functions keep addon startup code on inert values until the simulator
//! has backing state for spell override replacement, charge counters, and Maw
//! power border art.
