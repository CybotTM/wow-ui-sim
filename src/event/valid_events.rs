...
/// All known valid WoW event names, sorted for binary search.
...
/// Returns true if the event name is a known valid WoW event.
pub fn is_valid_event(name: &str) -> bool {
    VALID_EVENTS.binary_search(&name).is_ok()
}
