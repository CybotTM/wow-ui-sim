...
local function __wow_contribution_state_none()
  if Enum ~= nil and Enum.ContributionState ~= nil and Enum.ContributionState.None ~= nil then
    return Enum.ContributionState.None
  end
  return 0
end

local function __wow_contribution_result_success()
  if Enum ~= nil and Enum.ContributionResult ~= nil and Enum.ContributionResult.Success ~= nil then
    return Enum.ContributionResult.Success
  end
  return 0
end

local function __wow_contribution_default_color()
  if NORMAL_FONT_COLOR ~= nil then
...
if C_ContributionCollector.Close == nil then
  function C_ContributionCollector.Close()
  end
end

if C_ContributionCollector.Contribute == nil then
  function C_ContributionCollector.Contribute(_contributionID)
  end
end

if C_ContributionCollector.GetActive == nil then
  function C_ContributionCollector.GetActive()
  end
end

if C_ContributionCollector.GetAtlases == nil then
  function C_ContributionCollector.GetAtlases(_contributionID)
    return {}
  end
end

if C_ContributionCollector.GetBuffs == nil then
  function C_ContributionCollector.GetBuffs(_contributionID)
  end
end

if C_ContributionCollector.GetContributionAppearance == nil then
  function C_ContributionCollector.GetContributionAppearance(_contributionID, _contributionState)
    return {
      stateName = "",
      stateColor = __wow_contribution_default_color(),
      tooltipLine = "",
...
if C_ContributionCollector.GetContributionCollectorsForMap == nil then
  function C_ContributionCollector.GetContributionCollectorsForMap(_uiMapID)
    return {}
  end
end

if C_ContributionCollector.GetContributionResult == nil then
  function C_ContributionCollector.GetContributionResult(_contributionID)
    return __wow_contribution_result_success()
  end
end

if C_ContributionCollector.GetDescription == nil then
  function C_ContributionCollector.GetDescription(_contributionID)
    return ""
  end
end

if C_ContributionCollector.GetManagedContributionsForCreatureID == nil then
  function C_ContributionCollector.GetManagedContributionsForCreatureID(_creatureID)
    return {}
  end
end

if C_ContributionCollector.GetName == nil then
  function C_ContributionCollector.GetName(_contributionID)
    return ""
  end
end

if C_ContributionCollector.GetOrderIndex == nil then
  function C_ContributionCollector.GetOrderIndex(contributionID)
    return contributionID or 0
  end
end

if C_ContributionCollector.GetRequiredContributionCurrency == nil then
  function C_ContributionCollector.GetRequiredContributionCurrency(_contributionID)
  end
end

if C_ContributionCollector.GetRequiredContributionItem == nil then
  function C_ContributionCollector.GetRequiredContributionItem(_contributionID)
  end
end

if C_ContributionCollector.GetRewardQuestID == nil then
  function C_ContributionCollector.GetRewardQuestID(_contributionID)
    return 0
  end
end

if C_ContributionCollector.GetState == nil then
  function C_ContributionCollector.GetState(_contributionID)
    return __wow_contribution_state_none(), 0, nil, 0
  end
end

if C_ContributionCollector.HasPendingContribution == nil then
  function C_ContributionCollector.HasPendingContribution(_contributionID)
    return false
  end
end

if C_ContributionCollector.IsAwaitingRewardQuestData == nil then
  function C_ContributionCollector.IsAwaitingRewardQuestData(_contributionID)
    return false
  end
end
