...
pub fn register_c_account_store(lua: &Lua) -> Result<()> {
    ...
    t.set(
        "GetCategories",
        lua.create_function(|lua, _store_id: Value| {
    ...
    t.set(
        "GetCategoryInfo",
        lua.create_function(|lua, _cat_id: Value| {
    ...
    t.set(
        ...
        lua.create_function(|_, _store_id: Value| Ok(Value::Nil))?,
    )?;
    t.set(
        "GetCurrencyInfo",
        lua.create_function(|_, _currency_id: Value| Ok(Value::Nil))?,
    )?;
    t.set(
        "GetCurrencyAvailable",
        lua.create_function(|_, _currency_id: Value| Ok(0i32))?,
    )?;
    t.set(
        "GetItemInfo",
    ...
    t.set(
        "GetStoreFrontState",
        lua.create_function(|_, _store_id: Value| Ok(0i32))?,
    )?;
    t.set(
        "RequestStoreFrontInfoUpdate",
        lua.create_function(|_, _store_id: Value| Ok(()))?,
    )?;
    t.set(
        "BeginPurchase",
        lua.create_function(|_, _item_id: Value| Ok(()))?,
    )?;
    t.set(
        "RefundItem",
        lua.create_function(|_, _item_id: Value| Ok(()))?,
