//! Rilua A_Admin handlers (Movement through Transmog/collections).
//!
//! Split out of rilua_admin.rs to keep both files under the 750-line cap.
//! Covers Movement, Spec/talents, Buffs, Equipment, Zone, Economy, and
//! Transmog/collections sections. The `pub(super)` visibility matches
//! the entry-point TableBuilder chain in rilua_admin::register_all.

use super::rilua_admin::build_admin_buff;
