...
const COMBAT_LOG_RAID_TARGET_BASE_MASK: i32 = 0x0010_0000;

pub const COMBAT_LOG_RAID_TARGET_CONSTANTS: &[IntDef] = &[
    (
        "COMBATLOG_OBJECT_RAIDTARGET1",
        COMBAT_LOG_RAID_TARGET_BASE_MASK,
    ),
    (
        "COMBATLOG_OBJECT_RAIDTARGET2",
        COMBAT_LOG_RAID_TARGET_BASE_MASK << 1,
    ),
    (
        "COMBATLOG_OBJECT_RAIDTARGET3",
        COMBAT_LOG_RAID_TARGET_BASE_MASK << 2,
    ),
    (
        "COMBATLOG_OBJECT_RAIDTARGET4",
        COMBAT_LOG_RAID_TARGET_BASE_MASK << 3,
    ),
    (
        "COMBATLOG_OBJECT_RAIDTARGET5",
        COMBAT_LOG_RAID_TARGET_BASE_MASK << 4,
    ),
    (
        "COMBATLOG_OBJECT_RAIDTARGET6",
        COMBAT_LOG_RAID_TARGET_BASE_MASK << 5,
    ),
    (
        "COMBATLOG_OBJECT_RAIDTARGET7",
        COMBAT_LOG_RAID_TARGET_BASE_MASK << 6,
    ),
    (
        "COMBATLOG_OBJECT_RAIDTARGET8",
        COMBAT_LOG_RAID_TARGET_BASE_MASK << 7,
    ),
];
