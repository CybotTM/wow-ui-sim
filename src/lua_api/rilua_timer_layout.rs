...
//! # OnUpdate dispatch
//!
//! Already implemented in `rilua_script_helpers::dispatch_on_update`. No
...
//! rilua state access via `rilua_methods::borrow_state`.
//!
//! # String format
//!
...
// development) and use `rilua_methods::frame_id_from_stack` + `borrow_state`.
...
/// `rilua_script_helpers::dispatch_on_update` — no additional registration
/// is needed here.
