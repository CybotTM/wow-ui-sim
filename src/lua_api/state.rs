...
fn default_backpack_items() -> HashMap<(i32, i32), BagItem> {
    [
        (1, BagItem { item_id: 6948, stack_count: 1 }),  // Hearthstone
        (2, BagItem { item_id: 159, stack_count: 5 }),   // Refreshing Spring Water
        (3, BagItem { item_id: 4540, stack_count: 5 }),  // Tough Hunk of Bread
        (4, BagItem { item_id: 7005, stack_count: 1 }),  // Skinning Knife
    ]
    .into_iter()
