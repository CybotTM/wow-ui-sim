...
pub use super::state_types::{
    ...
    LfgActivityGroupInfo, LfgActivityInfo, LfdDungeonInfo, LootRollInfo, LuaErrorRecord,
...
fn default_lfg_activities() -> Vec<LfgActivityInfo> {
    ...
    vec![
        pve(1195, 295, 2, "Mists of Tirna Scithe (M+)", "MoTS M+", 5, 1, 0, false),
        pve(1188, 295, 2, "The Stonevault (M+)", "Stonevault M+", 5, 2, 0, false),
        pve(1190, 295, 2, "Ara-Kara, City of Echoes (M+)", "Ara-Kara M+", 5, 3, 0, false),
        pve(1296, 320, 3, "Nerub-ar Palace (Heroic)", "Nerub-ar HC", 20, 1, 15, true),
        pve(1295, 320, 3, "Nerub-ar Palace (Normal)", "Nerub-ar N", 20, 2, 14, true),
        pve(1350, 400, 6, "World Boss — Aggregation of Horrors", "World Boss", 40, 1, 0, false),
        pve(1700, 400, 6, "World Quests — Khaz Algar", "World Quests", 5, 2, 0, false),
...
fn default_lfd_dungeons() -> Vec<LfdDungeonInfo> {
    ...
    vec![
        ...
        d(-1, "Random Heroic Dungeon", 6, 1, 80, 80, 80, 5, 10, "", "", true, false),
        // War Within dungeons
        d(1201, "Ara-Kara, City of Echoes", 2, 2, 70, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-ARAKARA", "A spider-city dungeon.", false, false),
        d(1202, "City of Threads", 2, 2, 70, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-CITYOFTHREADS", "Nerubian city.", false, true),
        d(1203, "Mists of Tirna Scithe", 2, 2, 60, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-MISTSOFTIRNA", "A fae forest dungeon.", false, false),
        d(1204, "The Stonevault", 2, 2, 70, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-STONEVAULT", "Earthen vault.", false, true),
        d(1205, "Grim Batol", 2, 2, 15, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-GRIMBATOL", "Ancient dragon bastion.", false, false),
        d(1206, "The Dawnbreaker", 2, 2, 70, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-DAWNBREAKER", "Arathi warship.", false, false),
        d(1207, "Darkflame Cleft", 2, 2, 70, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-DARKFLAMECLEFT", "A torch-lit cavern.", false, true),
        d(1208, "The Rookery", 2, 2, 70, 80, 80, 5, 10, "Interface/LFGFRAME/UI-LFG-DUNGEON-ROOKERY", "Stormrook fortress.", false, false),
    ]
}
