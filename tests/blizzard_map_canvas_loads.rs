...
const MAP_CANVAS_DETAIL_LAYER_METHODS: &[&str] = &[
    "OnLoad",
    "SetMapAndLayer",
    "GetLayerIndex",
    "IsFullyLoaded",
...
const CVAR_DATA_PROVIDER_METHODS: &[&str] = &["Init", "IsCVarSet", "OnShow", "OnHide", "OnEvent"];

fn assert_mixin_methods_present(env: &WowLuaEnv, mixin: &str, methods: &[&str], context: &str) {
...
fn count_mixin_methods(env: &WowLuaEnv, mixin: &str) -> i64 {
    env.eval(&format!(
